...
namespace _9567A_V00___PI.Utilidades
{
    ...
    public class VariaveisGlobais
    {
        ...
        private static string Connection_DB_Users = @"Server=172.16.1.113\SQLEXPRESS2012,1433;Database=DB_Users_IHM;Integrated Security=false;User ID=sa;Password=33162600";
        private static string Connection_DB_Equip = @"Server = 172.16.1.113\SQLEXPRESS2012,1433;Database=DB_Equips_IHM;Integrated Security=false;User ID=sa;Password=33162600";
        private static string Connection_DB_Producao = @"Server = 172.16.1.113\SQLEXPRESS2012,1433;Database=DB_Producao_IHM;Integrated Security=false;User ID=sa;Password=33162600";

        private static string Connection_DB_Receitas = @"Server=172.16.1.113\SQLEXPRESS2012,1433;Database=DB_ReceitasPreMix;Integrated Security=false;User ID=sa;Password=33162600";
